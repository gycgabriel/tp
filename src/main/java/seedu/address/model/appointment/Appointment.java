...
public class Appointment {
     ...
     */
    public Appointment(Name name, Phone phone, Email email, Address address, Set<Tag> tags) {
    ...
    public boolean equals(Object other) {
        ...
        return otherAppointment.getName().equals(getName())
                && otherAppointment.getPhone().equals(getPhone())
                && otherAppointment.getEmail().equals(getEmail())
